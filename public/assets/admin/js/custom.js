...
// `<div class="imgprev" style="position: relative; width: 150px; height: 150px; margin-top: 10px; margin-right: 10px; border-radius: 5px; overflow: hidden">
//                     <img src="${el.url}" alt="" width="150px" height="150px">
//                     <span class="delete-img-prev" style="position: absolute; top: 10px; right: 10px" onclick="delete_image(${imgs_relate.indexOf(el)})">
...
// let imgRelEdit = document.querySelector('input.image-relate-upload-edit');
// console.log(imgRelEdit);

// const closeError = function() {
//     document.querySelector('.alert__error').remove();
// }

// const inp = document.querySelectorAll('.form-group input')
// const closeErrorBtn = document.querySelector('.alert__error .close');

// inp.forEach(el => {
//     el.addEventListener('click', closeError)
// });
