            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <form action="{{URL::to('/admin/category/update/'.$result->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="card-body" style="display: flex; font-size: 16px">
                                <div class="form-group col-xl-6">
                                    ...
                                    @enderror
                                    <input type="text" name="category_product_name" class="form-control" id="cate_name" value="{{$result->name}}">
                                </div>
                                <div class="form-group col-xl-6">
                                    <label for="cate_status">Hình ảnh thương hiệu</label>
                                    <input class="form-control cate-img-upload" type="file" id="cate_image" name="category_product_img_edit">
                                    <img class="img-temporary" style="margin-top: 10px;" src="/upload/products/{{$result->image}}" width="150px" height="150px" alt="">
...
<script type="text/javascript">
    document.querySelector('.cate-img-upload').addEventListener('change', function(e) {
