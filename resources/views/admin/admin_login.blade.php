            ...
            <div class="">
                ...
                <div class="container-login100">
                    <div class="wrap-login100 p-6" style="width: 500px"> 
                        <form class="login100-form validate-form" method="POST" action="/admin/login-action">
                            @csrf
                            ...
                            <div class="panel panel-primary">
                                ...
                                @if (session('errors'))
                                <div class="alert alert-danger mb-20 alert__error" style="transition: 0.5s; margin-top: 10px; display: flex; align-items: center; justify-content: space-between">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="tab5">
                                            <div class="wrap-input100 validate-input input-group" data-bs-validate="Valid email is required: ex@abc.xyz">
                                                ...
                                                <input class="input100 border-start-0 form-control ms-0" name="admin_email" type="email" placeholder="Email">
                                            </div>
                                            <div class="wrap-input100 validate-input input-group" id="Password-toggle">
                                                <a href="javascript:void(0)" class="input-group-text bg-white text-muted">
                                                    <i class="zmdi zmdi-eye text-muted" aria-hidden="true"></i>
                                                </a>
                                                <input class="input100 border-start-0 form-control ms-0" type="password" name="admin_password" placeholder="Password">
                                            </div>
