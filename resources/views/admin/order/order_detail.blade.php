    ...
    <div class="side-app">
        ...
        <table class="table" style="text-align: center">
          ...
          <div class="progess" style="margin-top: 50px; display: flex; justify-content: flex-end">
              <a style="display: inline-block; padding: 10px 0; border-radius: 5px; margin-bottom: 25px; width: 200px; text-align: center; background: #13bfa6; color: #fff" href="/admin/order/progressed/{{$get_id}}">Phê duyệt đơn hàng</a>
