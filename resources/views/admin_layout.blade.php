...
<head>
    ...
    <!-- FAVICON -->
    <link rel="shortcut icon" type="image/x-icon" href="/assets/admin/images/brand/favicon.ico" />
    ...
    <!-- BOOTSTRAP CSS -->
    <link id="style" href="/assets/admin/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" />

    <!-- STYLE CSS -->
    <link href="/assets/admin/css/style.css" rel="stylesheet" />
    <link href="/assets/admin/css/dark-style.css" rel="stylesheet" />
    <link href="/assets/admin/css/transparent-style.css" rel="stylesheet">
    <link href="/assets/admin/css/skin-modes.css" rel="stylesheet" />
    ...
    <!-- COLOR SKIN CSS -->
    <link id="theme" rel="stylesheet" type="text/css" media="all" href="/assets/admin/colors/color1.css" />
...
<body class="app sidebar-mini ltr light-mode">
    ...
    <div id="global-loader">
        <img src="/assets/admin/images/loader.svg" class="loader-img" alt="Loader">
    </div>
    <!-- /GLOBAL-LOADER -->
                                    ...
                                    <div class="d-flex order-lg-2">
                                        ...
                                        <div class="dropdown d-flex profile-1">
                                            <a href="javascript:void(0)" data-bs-toggle="dropdown" class="nav-link leading-none d-flex">
                                                <img src="/upload/avatar/{{Auth::user()->avatar}}" style="object-fit: cover" alt="profile-user"
                ...
                <div class="app-sidebar">
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="{{URL::to('admin/dashboard')}}"><i
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i style="font-size: 22px"
                                        class="side-menu__icon ph-cube"></i><span
                                        class="side-menu__label">Thương hiệu sản phẩm</span><i
                                        class="angle fe fe-chevron-right"></i></a>
                                <ul class="slide-menu">
                                    {{-- <li class="side-menu-label1"><a href="javascript:void(0)">Apps</a></li> --}}
                                    <li><a href="{{ URL::to('admin/category/all')}}" class="slide-item">Danh sách thương hiệu sản phẩm</a></li>
                                    <li><a href="{{ URL::to('admin/category/add')}}" class="slide-item">Thêm thương hiệu sản phẩm</a></li>
                                    {{-- <li><a href="{{ URL::to('admin/product/all')}}" class="slide-item">Sứa danh mcu</a></li>
                                    <li><a href="calendar2.html" class="slide-item">Danh sách sản phẩm giảm giá</a></li> --}}
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    {{-- <li class="side-menu-label1"><a href="javascript:void(0)">Apps</a></li> --}}
                                    <li><a href="{{ URL::to('admin/product/all')}}" class="slide-item">Danh sách tất cả sản phẩm</a></li>
                                    <li><a href="{{ URL::to('admin/product/add')}}" class="slide-item">Thêm mới sản phẩm</a></li>
                                    {{-- <li><a href="{{ URL::to('admin/product/all')}}" class="slide-item">Sứa danh mcu</a></li>
                                    <li><a href="calendar2.html" class="slide-item">Danh sách sản phẩm giảm giá</a></li> --}}
                                    {{-- <li><a href="chat.html" class="slide-item"> Chat</a></li>
                                    <li><a href="notify.html" class="slide-item"> Notifications</a></li>
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i style="font-size: 22px"
                                        class="side-menu__icon ph-image"></i><span
                                        class="side-menu__label">Slider</span><i
                                        class="angle fe fe-chevron-right"></i></a>
                                <ul class="slide-menu">
                                    {{-- <li class="side-menu-label1"><a href="javascript:void(0)">Apps</a></li> --}}
                                    <li><a href="{{ URL::to('admin/slider/all')}}" class="slide-item">Danh sách tất cả slider</a></li>
                                    <li><a href="{{ URL::to('admin/slider/add')}}" class="slide-item">Thêm mới slider</a></li>
                                    {{-- <li><a href="{{ URL::to('admin/product/all')}}" class="slide-item">Sứa danh mcu</a></li>
                                    <li><a href="calendar2.html" class="slide-item">Danh sách sản phẩm giảm giá</a></li> --}}
                                    {{-- <li><a href="chat.html" class="slide-item"> Chat</a></li>
                                    <li><a href="notify.html" class="slide-item"> Notifications</a></li>
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i style="font-size: 22px"
                                        class="side-menu__icon ph-users"></i><span
                                        class="side-menu__label">User</span><i
                                        class="angle fe fe-chevron-right"></i></a>
                                <ul class="slide-menu">
                                    {{-- <li class="side-menu-label1"><a href="javascript:void(0)">Apps</a></li> --}}
                                    <li><a href="{{ URL::to('admin/user/all')}}" class="slide-item">Danh sách tất cả user</a></li>
                                    <li><a href="{{ URL::to('admin/user/add')}}" class="slide-item">Phân quyền user</a></li>
                                    {{-- <li><a href="{{ URL::to('admin/product/all')}}" class="slide-item">Sứa danh mcu</a></li>
                                    <li><a href="calendar2.html" class="slide-item">Danh sách sản phẩm giảm giá</a></li> --}}
                                    {{-- <li><a href="chat.html" class="slide-item"> Chat</a></li>
                                    <li><a href="notify.html" class="slide-item"> Notifications</a></li>
                            ...
                            <li class="slide" style="position: relative;">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i style="font-size: 22px"
                                        class="side-menu__icon ph-scroll"></i><span
                                        class="side-menu__label">Đơn hàng</span><i
                                        class="angle fe fe-chevron-right"></i></a>
                                <ul class="slide-menu">
                                    {{-- <li class="side-menu-label1"><a href="javascript:void(0)">Apps</a></li> --}}
                                    <li><a href="{{ URL::to('admin/order/all')}}" class="slide-item">Danh sách tất cả đơn hàng</a></li>
                                ...
                                <div style="position: absolute; top: 50%; transform: translateY(-45%); right: 80px; font-size: 10px; width: 18px; height: 18px; border-radius: 50%; line-height: 18px; text-align: center; background: #fc2a68; color: #fff" class="count">
                                    <p>1</p>
                                </div>
                            </li>
                        ...
                        <ul class="row p-3">
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block active">
                                    <span class="country-selector"><img alt="" src="/assets/admin/images/flags/us_flag.jpg"
                            ...
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt=""
                                        src="/assets/admin/images/flags/italy_flag.jpg"
                            ...
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt=""
                                        src="/assets/admin/images/flags/spain_flag.jpg"
                            ...
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt=""
                                        src="/assets/admin/images/flags/india_flag.jpg"
                            ...
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt=""
                                        src="/assets/admin/images/flags/french_flag.jpg"
                            ...
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt=""
                                        src="/assets/admin/images/flags/russia_flag.jpg"
                            ...
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt=""
                                        src="/assets/admin/images/flags/germany_flag.jpg"
                            ...
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt=""
                                        src="/assets/admin/images/flags/argentina.jpg"
                                        class="me-3 language"></span>Argentina
                                </a>
                            </li>
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="" src="/assets/admin/images/flags/malaysia.jpg"
                                        class="me-3 language"></span>Malaysia
                                </a>
                            </li>
                            <li class="col-lg-6 mb-2">
                                <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="" src="/assets/admin/images/flags/turkey.jpg"
    ...
    <!-- CHART-CIRCLE JS-->
    <script src="/assets/admin/js/circle-progress.min.js"></script>

    <!-- PIETY CHART JS-->
    <script src="/assets/admin/plugins/peitychart/jquery.peity.min.js"></script>
    <script src="/assets/admin/plugins/peitychart/peitychart.init.js"></script>

    <!-- SIDEBAR JS -->
    <script src="/assets/admin/plugins/sidebar/sidebar.js"></script>

    <!-- Perfect SCROLLBAR JS-->
    <script src="/assets/admin/plugins/p-scroll/perfect-scrollbar.js"></script>
    <script src="/assets/admin/plugins/p-scroll/pscroll.js"></script>
    <script src="/assets/admin/plugins/p-scroll/pscroll-1.js"></script>

    <!-- INTERNAL CHARTJS CHART JS-->
    <script src="/assets/admin/plugins/chart/Chart.bundle.js"></script>
    <script src="/assets/admin/plugins/chart/rounded-barchart.js"></script>
    <script src="/assets/admin/plugins/chart/utils.js"></script>
    ...
    <script src="/assets/admin/plugins/apexchart/irregular-data-series.js"></script>

    <!-- C3 CHART JS -->
    <script src="/assets/admin/plugins/charts-c3/d3.v5.min.js"></script>
    <script src="/assets/admin/plugins/charts-c3/c3-chart.js"></script>
    ...
    <script src="/assets/admin/plugins/flot/jquery.flot.fillbetween.js"></script>
    <script src="/assets/admin/plugins/flot/chart.flot.sampledata.js"></script>
    <script src="/assets/admin/plugins/flot/dashboard.sampledata.js"></script>

    <!-- INTERNAL Vector js -->
    <script src="/assets/admin/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="/assets/admin/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>

    <!-- SIDE-MENU JS-->
    <script src="/assets/admin/plugins/sidemenu/sidemenu.js"></script>
    ...
    <!-- Color Theme js -->
    <script src="/assets/admin/js/themeColors.js"></script>

    <!-- CUSTOM JS -->
    <script src="/assets/admin/js/custom.js"></script>
    <script>
        document.querySelector('.count').textContent = document.querySelectorAll('tr.cart-progressing').length;
